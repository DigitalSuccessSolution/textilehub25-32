...
const TradeCircular = () => {
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.cream }}>
      ...
      <div className="pb-16 max-w-[90rem] mx-auto px-6 lg:px-14 py-10">
          ...
          {circulars.map((circular) => (
            ...
            >
              <div className="flex flex-col items-start gap-4 mb-5">
                <div style={{ width: 44, height: 44, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(139,105,20,0.08)', border: `1px solid rgba(196,163,90,0.2)` }}>
