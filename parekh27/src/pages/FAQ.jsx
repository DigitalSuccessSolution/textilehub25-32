...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes, Fashion Heritage ships globally. International shipping charges and delivery times vary based on the destination and order volume."
  },
  {
...
export default function FAQ() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.cream, minHeight: '100vh' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 pt-16 md:pt-32 pb-24">
