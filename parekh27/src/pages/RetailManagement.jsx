    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.cream }}>
      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 pt-16 md:pt-32 pb-24">
        ...
        <p style={{ textAlign: 'center', fontSize: 15, color: C.stone, marginBottom: 40, fontWeight: 400, maxWidth: 560, margin: '0 auto 40px', lineHeight: 1.7 }}>
          Fashion Heritage is administered and governed by highly skilled, experienced and qualified Management with decades of expertise in the textile industry.
        </p>
        ...
        >
          {teamMembers.map((member, i) => (
            ...
            >
              ...
              <a
                href={`mailto:${member.name.toLowerCase().replace(' ', '')}@fashionheritage.com`}
                style={{
