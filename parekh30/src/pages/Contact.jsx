...
const contactDetails = [
  { icon: MapPin, label: 'Headquarters', lines: ['Textile Treasure, Block A', 'Textile Park, Surat, Gujarat, India - 395002'] },
        ...
        >
          <div 
            style={{
              ...
              boxShadow: '0 12px 32px rgba(14, 107, 107, 0.08)',
              height: '450px'
            }}
          ...
          >
            <iframe
              ...
              title="Textile Treasure Textile Mall Location"
            />
          </div>
        </motion.div>
      </div>
