            ...
            >
              ...
              <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  <span style={{ fontSize: 11, color: C.stone, fontWeight: 500 }}>Published: {post.date}</span>
                </div>
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, fontWeight: 700, color: C.soil, margin: '0 0 10px', lineHeight: 1.4 }}>
                  {post.title}
                </h3>
                <p style={{ fontSize: 13, color: C.stone, lineHeight: 1.6, margin: '0 0 16px', fontWeight: 400, flex: 1 }}>
                  {post.description}
                </p>
                <p style={{ fontSize: 12, color: C.stone, margin: 0, fontWeight: 500 }}>By {post.author}</p>
              </div>
            </motion.article>
          ))}
        </div>
