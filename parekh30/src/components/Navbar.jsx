    ...
    >
        ...
        <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-3 group shrink-0 text-left">
            <div style={{
              ...
              boxShadow: '0 4px 14px rgba(14,107,107,0.25)',
            }}>
              <Gem size={20} color="#c8922a" />
            </div>
                      ...
                      return (
                        <Link
                          ...
                          style={{
                            ...
                            background: active ? 'rgba(14,107,107,0.06)' : 'transparent',
                          }}
                        ...
                        >
                          <span style={{ width: 5, height: 5, borderRadius: '50%', background: active ? C.accent : 'rgba(14,107,107,0.25)', flexShrink: 0, display: 'inline-block' }} />
                          {item.name}
                        </Link>
                      );
                    })}
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Drawer header */}
            <div style={{ background: 'linear-gradient(135deg, #0e6b6b, #094f4f)', padding: '16px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
            ...
            <div className="flex-1 overflow-y-auto px-5 py-6 pb-28 space-y-2">
                ...
                {directNavItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        background: active ? 'rgba(14,107,107,0.06)' : '#f8fefe',
                        ...
                        {dropdownNavItems.map((item) => {
                          ...
                          return (
                            <Link
                              ...
                              style={{
                                background: active ? 'rgba(14,107,107,0.05)' : '#f8fefe',
                                borderColor: active ? C.primary : C.border,
                                color: active ? C.primary : C.soil,
                              }}
                            >
              ...
              <div className="pt-4">
                <Link
                  ...
                  style={{ background: 'linear-gradient(135deg, #0e6b6b, #c8922a)' }}
                >
                  Contact Us
                </Link>
              </div>
