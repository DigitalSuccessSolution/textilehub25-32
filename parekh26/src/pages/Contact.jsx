...
const contactDetails = [
  ...
  { icon: Mail, label: 'Email Enquiries', lines: ['info@texmart.com', 'sales@texmart.com'] },
...
export default function Contact() {
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.bg, minHeight: '100vh' }}>
      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-8 lg:px-14 text-left pt-24 lg:pt-32 pb-16 lg:pb-24">
          ...
          >
            ...
            >
              <iframe
                ...
                title="Texmart Retail Mall Location"
              />
            </div>
          </motion.div>
